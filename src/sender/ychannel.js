...
YChannel.prototype._logChannel = function (info) {
    this.loggerStack1.log(util.format('gpns-sender channel[%s:%s]: %s',
        this._remoteAddress, this._remotePort, this.format.apply(null, arguments)));
};
YChannel.prototype._traceChannel = function () {
    this.loggerStack1.trace(util.format('gpns-sender channel[%s:%s]: %s',
        this._remoteAddress, this._remotePort, this.format.apply(null, arguments)));
};
YChannel.prototype._debugChannel = function () {
    this.loggerStack1.debug(util.format('gpns-sender channel[%s:%s]: %s',
        this._remoteAddress, this._remotePort, this.format.apply(null, arguments)));
};
YChannel.prototype._infoChannel = function () {
    this.loggerStack1.info(util.format('gpns-sender channel[%s:%s]: %s',
        this._remoteAddress, this._remotePort, this.format.apply(null, arguments)));
};
YChannel.prototype._warnChannel = function () {
    this.loggerStack1.warn(util.format('gpns-sender channel[%s:%s]: %s',
        this._remoteAddress, this._remotePort, this.format.apply(null, arguments)));
};
YChannel.prototype._errorChannel = function () {
    this.loggerStack1.error(util.format('gpns-sender channel[%s:%s]: %s',
        this._remoteAddress, this._remotePort, this.format.apply(null, arguments)));
};
